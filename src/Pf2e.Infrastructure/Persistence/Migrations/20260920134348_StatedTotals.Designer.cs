...
namespace Pf2e.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920134348_StatedTotals")]
    partial class StatedTotals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pf2e.Domain.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Pf2e.Domain.Rules.RuleAlias", b =>
                {
                    ...
                    b.Property<string>("NowId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");

                    b.HasKey("Was", "Category");

                    b.ToTable("RuleAliases", (string)null);
                });
            ...
            modelBuilder.Entity("Pf2e.Domain.Tracking.TrackedCharacter", b =>
                {
                    ...
                    b.Property<string>("DowntimeActivity")
                        .HasColumnType("TEXT");

                    b.Property<int?>("DowntimeTaskLevel")
                        .HasColumnType("INTEGER");

                    b.Property<string>("ExplorationActivity")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int?>("StatedMaxHitPoints")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("TreatedAtMinute")
                        .HasColumnType("INTEGER");
